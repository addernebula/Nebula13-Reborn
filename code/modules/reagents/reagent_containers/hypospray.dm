...
/obj/item/reagent_containers/hypospray/medipen/survival
	...
	list_reagents = list( /datum/reagent/medicine/epinephrine = 8, /datum/reagent/medicine/oxandrolone = 8, /datum/reagent/medicine/c2/libital = 8 ,/datum/reagent/medicine/leporazine = 6) //Also edit feito por Enigma Dia 28/08
